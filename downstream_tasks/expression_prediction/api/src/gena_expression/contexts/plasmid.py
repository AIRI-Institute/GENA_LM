...
class PlasmidRecord:
    ...
    def __init__(
        ...
        *,
        ...
        """Normalize a plasmid sequence and parse its GenBank annotations."""
    ...
    def _download_text(url: str) -> str:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "gena-expression-plasmid-context/1.0"})
        with urllib.request.urlopen(req) as response:
            return response.read().decode("utf-8")

    @staticmethod
    def _ncbi_sviewer_url(accession: str, report: str) -> str:
        """Build an NCBI sequence-viewer download URL."""
    ...
    def plasmid_context(
        ...
        *,
        ...
        def get_insert_fn(element: str) -> Callable[[AnnotatedSequence, str], AnnotatedSequence]:
            """Build and cache the insert function for one MPRA element."""
...
class PlasmidCollection:
    ...
    def __init__(
        ...
        *,
        ...
        """Configure element routing and lazy plasmid-context caches."""
