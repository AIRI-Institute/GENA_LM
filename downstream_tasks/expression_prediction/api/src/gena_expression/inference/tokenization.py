...
class CenteredTokenizer:
    ...
    def __init__(
        ...
        """Configure centered DNA tokenization and special token IDs."""
    ...
    def _to_tensor(values: list[int]):
        """Convert integer token IDs to a long tensor."""
    ...
    def _as_annotated(sequence: AnnotatedSequence | str) -> AnnotatedSequence:
        """Wrap a plain sequence while preserving annotated inputs."""
    ...
    def _resolve_center(self, sequence: AnnotatedSequence, center: int | str | Feature) -> int:
        """Resolve an integer, feature, or named sequence center."""
