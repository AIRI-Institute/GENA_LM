...
class ExpressionCounts(nn.Module):
    ...
    def forward(
        ...
        sequence_output = self.caduceus_model.backbone.embeddings(input_ids) 
        ...
        caduceus_cells_output = self.caduceus_model(inputs_embeds=seq_out_flat,return_dict=True).last_hidden_state 
