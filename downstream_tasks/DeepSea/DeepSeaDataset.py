...
from src.gena_lm.utils import concatenate_encodings, symmetric_pad_and_truncate_context, get_service_token_encodings
...
class DeepSeaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        features = self.tokenizer(sample, add_special_tokens=False, padding=False, truncation=False,
                                   return_tensors='np')
        _,_,features,padding = symmetric_pad_and_truncate_context(left_encoding=None,
                                                      right_encoding=None,
                                                      left_encoding=features,
