...
horovodrun --gloo -np $NP python -m downstream_tasks.enformer.run_enformer_finetuning_rmt \
        ...
        --init_checkpoint ${HOME_PATH}/kuratov/dnalm/runs/enformer/bert_large_512_lastln_t2t_1000G_bs256_lr_1e-04_fp16_enformer/run_1/rmt_seglen_512_len1010_maxnsegm_2_bins38_binspersegm_19_msz_5_bptt-1_mix_0.5_augs_1_lr1e-04_AdamW_cosine_wd0.0_p40_bs128_it200000/run_1/model_best.pth \
