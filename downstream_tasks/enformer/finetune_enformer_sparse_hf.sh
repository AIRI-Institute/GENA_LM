...
BASE_MODEL=hf_bigbird_base_4096_t2t_1000G_bs256_FusedAdam_linear_lr_1e-04_wd_0.0_2x8
...
do
for LR in 1e-04 5e-05 2e-05 #1e-05 5e-06 #1e-04 5e-05 2e-05
do
...
horovodrun --gloo -np $NP python -m downstream_tasks.enformer.run_enformer_finetuning \
        ...
        --model_cls downstream_tasks.enformer.enformer_model:BigBirdForEnformer \
        --init_checkpoint ${PRETRAINED_PATH}/${BASE_MODEL}/${BASE_CKPT}.pth \
        --input_seq_len 4096 --bins_per_sample 192 --data_n_workers 4 \
        --use_augs $AUGS \
