...
INPUT_SEQ_LENS=(505 8080 12120 24240 1010 2020 4040 16160) #(505 1010 2020 4040 8080 12120 16160 24240) # (512 1024 2048 4096 8192 16384 24576)
BINS_PER_SAMPLES=(19 304 456 912 38 76 152 608) #(19 38 76 152 304 456 608 912)
CTX_BINS_PER_SAMPLES=(9 144 216 432 18 36 72 288) #(9 18 36 72 144 216 288 432) #(4 8 16 32 64 96 128 192) #(15 30 60 120 240 360 480 720)
...
#--dont_save_metrics
python -m downstream_tasks.enformer.run_enformer_evaluation_augs \
