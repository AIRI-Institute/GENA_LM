...
if __name__ == '__main__':
    ...
    if args.valid_data_path:
        ...
        valid_dataset = AnnotationDataset(valid_data_path, max_seq_len=args.input_seq_len, tmp_valid_len=1800)
    ...
    if args.test_data_path:
        ...
        test_dataset = AnnotationDataset(test_data_path, max_seq_len=args.input_seq_len, tmp_valid_len=1800)
