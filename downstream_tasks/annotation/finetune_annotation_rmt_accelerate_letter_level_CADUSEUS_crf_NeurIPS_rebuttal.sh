...
TASK=NeurIPS_REBUTTAL_CADUSEUS_ps_32k_unfreeze_backbone_shuffle_starts_CRF_2_classes_EXON_INTRON
...
echo $MODEL_PATH
accelerate launch --main_process_port=29502 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_letter_level_CADUSEUS_crf_NeurIPS_rebuttal.py \
        ...
        --checkpoint /home/jovyan/dnalm/runs/CADUCEUS_full_250k_shawerma/model.safetensors \
