...
TASK=annotation_bert_large_mane_no_intergenic_combined_16k_bpe_UNET_ICML_rebuttal
...
INPUT_SEQ_LEN=16000
LETTER_LEVEL_INPUT_SEQ_LEN=128000
# RMT
...
echo $MODEL_PATH
accelerate launch --main_process_port=29502 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_letter_level_UNET_segmented.py \
        --data_path /home/jovyan/shares/SR003.nfs2/mane_no_intergenic_combined/mane_transcript_train_dataset_max_exon_cds.hdf5 \
        --valid_data_path /home/jovyan/shares/SR003.nfs2/mane_no_intergenic_combined/mane_transcript_train_dataset_max_exon_cds.hdf5 \
