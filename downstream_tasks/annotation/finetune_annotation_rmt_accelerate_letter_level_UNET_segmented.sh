...
TASK=annotation_bert_base_mane_no_intergenic_combined_4k_UNET_backbone_real_unfreezed_start_from_rmt_pretraining_shuffle_starts_mRNA_only
...
echo $MODEL_PATH
accelerate launch --main_process_port=29509 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_letter_level_UNET_segmented.py \
        --data_path /home/jovyan/dnalm/downstream_tasks/annotation/mane_transcript_train_dataset_max_exon_cds_mRNA_only.h5 \
        --valid_data_path /home/jovyan/dnalm/downstream_tasks/annotation/mane_transcript_val_dataset_max_exon_cds_mRNA_only.h5 \
        --test_data_path /home/jovyan/dnalm/downstream_tasks/annotation/mane_transcript_val_dataset_max_exon_cds_mRNA_only.h5 \
