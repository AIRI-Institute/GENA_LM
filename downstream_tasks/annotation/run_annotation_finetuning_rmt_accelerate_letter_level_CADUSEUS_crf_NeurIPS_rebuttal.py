...
from downstream_tasks.annotation.transcript_GenePredictionDataset_letter_level_CADUSEUS_crf_NeurIPS_rebuttal import AnnotationDataset
...
if __name__ == '__main__':
    ...
    def metrics_fn(data):
        ...
        label_dict = {0: 'EXON', 1: 'INTRON'} # {0: '5UTR', 1: 'EXON', 2: 'INTRON', 3: '3UTR', 4: 'CDS'}
