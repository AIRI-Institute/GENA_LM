...
class AnnotationDataset(Dataset):
    ...
    def shuffle_starts_in_intergenic_func(self, input_ids, labels, token_atcg):
        ...
        # print('OOOOOOOOO', self.tokenizer.decode(token_atcg[0, :10]), input_ids[:, :4], labels[:, :4])
        return input_ids, labels, token_atcg
    ...
    def __getitem__(self, idx):
        ...
        # print(self.tokenizer.decode(output['letter_level_tokens'][output['letter_level_labels_mask']]))
