...
from downstream_tasks.annotation.transcript_GenePredictionDataset_letter_level_CADUSEUS import AnnotationDataset
...
if __name__ == '__main__':
    ...
    train_dataset = AnnotationDataset(data_path, tokenizer=tokenizer, max_atcg_seq_len=args.letter_level_input_seq_len, tokenizer_caduseus=tokenizer_caduseus, shuffle_starts=False)
