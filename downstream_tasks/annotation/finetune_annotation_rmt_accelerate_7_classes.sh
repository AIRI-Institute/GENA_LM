...
TASK=annotation_bert_large_human_7_classes_no_intergenic_combined_16k_bpe_full_up_to_250k_exon_level_choosing_from_scratch_middle_lr_big_wd_continue_corrected_continue
...
echo $MODEL_PATH
accelerate launch --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_7_classes.py \
        --data_path /home/jovyan/shares/SR003.nfs2/mane_no_intergenic_7_classes/human_mane_forward_nc_labels.hdf5 \
        --valid_data_path /home/jovyan/shares/SR003.nfs2/mane_no_intergenic_7_classes/human_mane_forward_nc_labels_val.hdf5 \
        --test_data_path /home/jovyan/shares/SR003.nfs2/mane_no_intergenic_7_classes/human_mane_forward_nc_labels_val.hdf5 \
        ...
        --rmt_checkpoint /home/jovyan/dnalm/runs/annotation_bert_large_human_7_classes_no_intergenic_combined_16k_bpe_full_up_to_250k_exon_level_choosing_from_scratch_middle_lr_big_wd_continue_corrected/bert_large_512_lastln_t2t_1000G_bs256_lr_1e-04_fp16/model_1750000/rmt_seglen_512_len16000_maxnsegm_10000_msz_5_bptt-1_lr5e-05_AdamW_constant_with_warmup_wd1e-04_p10000_bs64_it500000/run_1/model_best/pytorch_model.bin \
        ...
        --bptt_depth -1 \
        --iters $ITERS \
        --batch_size $BS --gradient_accumulation_steps 4 \
