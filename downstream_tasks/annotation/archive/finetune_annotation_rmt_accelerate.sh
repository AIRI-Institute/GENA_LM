...
TASK=annotation_bert_large_more_intergenic_new_42k_bpe_from_scratch_bug_fix_continue_with_softer_parameters_all_metrics_shawerma
...
echo $MODEL_PATH
accelerate launch --main_process_port=29500 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate.py \
