...
TASK=annotation_upweighted_edges_large_42k_flash_attention_reverse
...
echo $MODEL_PATH
accelerate launch --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_large_16k_reverse.py \
        ...
        --rmt_checkpoint /home/jovyan/dnalm/runs/annotation_upweighted_edges_large_16k_reverse/bert_large_512_lastln_t2t_1000G_bs256_lr_1e-04_fp16/model_1750000/rmt_seglen_512_len16000_maxnsegm_10000_msz_5_bptt-1_lr1e-05_AdamW_constant_with_warmup_wd0_p10000_bs64_it500000/run_1/model_best/pytorch_model.bin \
