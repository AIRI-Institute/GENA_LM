...
from downstream_tasks.annotation.transcript_GenePredictionDataset_shuffle_start import AnnotationDataset
...
parser.add_argument('--max_shuffle_start_pos', type=int, default=100, help='max start idx for adjusting sequences')
...
if __name__ == '__main__':
    ...
    train_dataset = AnnotationDataset(data_path, max_seq_len=args.input_seq_len, max_shuffle_start_pos=args.max_shuffle_start_pos)
    ...
    if args.valid_data_path:
        ...
        valid_dataset = AnnotationDataset(valid_data_path, max_seq_len=args.input_seq_len, max_shuffle_start_pos=args.max_shuffle_start_pos)
    ...
    if args.test_data_path:
        ...
        test_dataset = AnnotationDataset(test_data_path, max_seq_len=args.input_seq_len, max_shuffle_start_pos=args.max_shuffle_start_pos)
