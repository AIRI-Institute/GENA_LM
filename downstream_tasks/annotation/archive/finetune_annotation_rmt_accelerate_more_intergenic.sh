...
TASK=annotation_upweighted_edges_large_more_intergenic
...
echo $MODEL_PATH
accelerate launch --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_more_intergenic.py \
        --data_path /home/jovyan/dnalm/downstream_tasks/annotation/data/more_intergenic_train_dataset.hdf5 \
        --valid_data_path /home/jovyan/dnalm/downstream_tasks/annotation/data/more_intergenic_val_dataset.hdf5 \
        --test_data_path /home/jovyan/dnalm/downstream_tasks/annotation/data/more_intergenic_val_dataset.hdf5 \
