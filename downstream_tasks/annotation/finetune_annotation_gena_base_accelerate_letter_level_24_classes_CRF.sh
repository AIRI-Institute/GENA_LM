...
TASK=test_val_one_sample_with_CRF_with_fixed_transition_matrix_2_layers_started_from_no_CRF_trained_checkpoint_low_lr
...
echo $MODEL_PATH
accelerate launch --main_process_port=29507 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_gena_base_accelerate_letter_level_24_classes_CRF.py \
        ...
        --backbone_cls src.gena_lm.modeling_bert:BertForLetterLevelTokenLinearCRFClassificationNucleotideFixedTransition \
        --full_checkpoint /home/jovyan/dnalm/runs/test_val_one_sample_no_CRF_2_layers/bert_large_512_lastln_t2t_1000G_bs256_lr_1e-04_fp16/model_1750000/rmt_seglen__len4096_maxnsegm__msz__bptt_lr5e-05_AdamW_constant_with_warmup_wd1e-04_p10000_bs_it500000/run_1/model_best/pytorch_model.bin \
        ...
        --log_interval 100 --valid_interval 3000 --early_stopping_patience $PATIENCE \
        --seed $(($N+42))
done
done
echo "done"
...
# --initial_checkpoint /home/jovyan/dnalm/model_hub/bert_base_512_lastln_t2t_1000G_bs256_lr_1e-04_linear_fp16/model_best.pth \
# --backbone_trainable \
