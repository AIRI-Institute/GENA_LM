...
TASK=annotation_UNET_sub_model_concat_embeddings_MANE_start_from_best_forward_bidirectional_rmt_freeze_gena_models
...
echo $MODEL_PATH
accelerate launch --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_letter_level_bidirectional_unet.py \
        ...
        --model_cls src.gena_lm.modeling_rmt:RMTEncoderForLetterLevelTokenClassificationBidirectionalUNET \
        ...
        --backward_checkpoint /home/jovyan/dnalm/runs/annotation_bert_large_mane_no_intergenic_combined_42k_bpe_full_up_to_250k_exon_cds_choosing/bert_large_512_lastln_t2t_1000G_bs256_lr_1e-04_fp16/model_1750000/rmt_seglen_512_len42000_maxnsegm_10000_msz_5_bptt-1_lr1e-05_AdamW_constant_with_warmup_wd2e-05_p10000_bs64_it500000/run_1/model_best/pytorch_model.bin \
