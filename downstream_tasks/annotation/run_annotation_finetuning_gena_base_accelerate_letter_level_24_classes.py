...
from downstream_tasks.annotation.transcript_GenePredictionDataset_letter_level_gena_base_24_classes import AnnotationDataset
...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=per_worker_batch_size, sampler=train_sampler, **kwargs) # persistent_workers=True for seamless epoch switch
