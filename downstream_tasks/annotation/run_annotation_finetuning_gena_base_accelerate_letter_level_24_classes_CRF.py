...
from downstream_tasks.annotation.transcript_GenePredictionDataset_letter_level_gena_base_24_classes_CRF import AnnotationDataset
...
if __name__ == '__main__':
    ...
    if args.initial_checkpoint is not None:
        logger.info(f'loading pre-trained backbone from {args.initial_checkpoint}')
    ...
    pos_weight = torch.tensor([1.0]*24) # torch.tensor([128.0, 11.8, 1.0, 33.6, 27.4, 11.7]) # torch.tensor([128.0, 11.8, 1.0, 33.6, 27.4, 11.7]) # torch.tensor([2.0, 0.05, 0.5])
