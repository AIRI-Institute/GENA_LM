...
TASK=annotation_bert_base_FULL_ATCG_RMT_MANE_4k
...
echo $MODEL_PATH
accelerate launch --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_atcg.py \
        --data_path /home/jovyan/shares/SR003.nfs2/mane_atcg/main_transcript_train_dataset_max_cds.hdf5 \
        --valid_data_path /home/jovyan/shares/SR003.nfs2/mane_atcg/main_transcript_val_dataset_max_cds.hdf5 \
        --test_data_path /home/jovyan/shares/SR003.nfs2/mane_atcg/main_transcript_val_dataset_max_cds.hdf5 \
