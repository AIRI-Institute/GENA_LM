...
TASK=NATURE_GENA_RMT_4k_NUCL_tokens_ONLY_backbone_trainable_shuffle_starts_24_classes_fast_CRF_complete_random_start_grad_test
...
echo $MODEL_PATH
accelerate launch --main_process_port=29509 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_GENA_intergenic_crf.py \
        ...
        --model_cls src.gena_lm.modeling_rmt:RMTEncoderForLetterLevelTokenClassificationLinearSegmentedRepeaterCRFfastFixedTransition \
