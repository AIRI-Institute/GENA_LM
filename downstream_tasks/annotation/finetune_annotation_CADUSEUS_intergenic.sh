...
LETTER_LEVEL_INPUT_SEQ_LEN=10000
...
# --checkpoint /home/jovyan/dnalm/runs/PIPELINE_CADUSEUS_ps_10k_backbone_trainable_shuffle_starts_TSS_PolyA_only_whole_chrs_many_transcripts/model_no_fc.safetensors \
