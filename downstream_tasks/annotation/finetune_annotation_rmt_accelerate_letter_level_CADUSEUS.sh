...
TASK=NeurIPS_CADUSEUS_ph_32k_new_UNET
...
LETTER_LEVEL_INPUT_SEQ_LEN=32000
...
echo $MODEL_PATH
accelerate launch --main_process_port=29501 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_letter_level_CADUSEUS.py \
        ...
        --tokenizer $TOKENIZER \
        --backbone_cls src.gena_lm.modeling_rmt:CADUSEUS_for_token_classification_UNET \
