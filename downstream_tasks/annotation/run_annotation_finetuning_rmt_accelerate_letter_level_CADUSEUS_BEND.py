...
from downstream_tasks.annotation.transcript_GenePredictionDataset_letter_level_CADUSEUS_BEND import AnnotationDataset
...
if __name__ == '__main__':
    ...
    train_dataset = AnnotationDataset(data_path, tokenizer=tokenizer, max_atcg_seq_len=args.letter_level_input_seq_len, tokenizer_caduseus=tokenizer_caduseus, shuffle_starts=True)
    ...
    if args.valid_data_path:
        ...
        valid_dataset = AnnotationDataset(valid_data_path, tokenizer=tokenizer, max_atcg_seq_len=args.letter_level_input_seq_len, tokenizer_caduseus=tokenizer_caduseus)
    ...
    if args.test_data_path:
        ...
        test_dataset = AnnotationDataset(test_data_path, tokenizer=tokenizer, max_atcg_seq_len=args.letter_level_input_seq_len, tokenizer_caduseus=tokenizer_caduseus)
