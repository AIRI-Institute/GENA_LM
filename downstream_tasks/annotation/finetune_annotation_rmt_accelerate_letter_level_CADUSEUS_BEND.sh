...
TASK=NeurIPS_CADUSEUS_ph_15k_unfreeze_backbone_shuffle_starts_BEND
...
echo $MODEL_PATH
accelerate launch --main_process_port=29502 --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_letter_level_CADUSEUS_BEND.py \
