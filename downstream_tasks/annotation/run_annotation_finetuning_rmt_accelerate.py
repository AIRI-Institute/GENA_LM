...
if __name__ == '__main__':
    ...
    train_dataset = AnnotationDataset(data_path, max_seq_len=args.input_seq_len, tmp_valid_len=None, use_shortener=True)
    ...
    if args.valid_data_path:
        ...
        valid_dataset = AnnotationDataset(valid_data_path, max_seq_len=args.input_seq_len, tmp_valid_len=None, use_shortener=False)
