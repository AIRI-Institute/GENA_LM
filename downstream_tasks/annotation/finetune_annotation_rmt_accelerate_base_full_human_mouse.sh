...
TASK=annotation_upweighted_edges_base_full_human_mouse
...
echo $MODEL_PATH
accelerate launch --num_processes $NP --config_file ./downstream_tasks/annotation/accelerate.yaml ./downstream_tasks/annotation/run_annotation_finetuning_rmt_accelerate_prot_cod_hum_mouse.py \
        --data_path /home/jovyan/dnalm/downstream_tasks/annotation/data/all_genes_human_mouse.hdf5 \
        ...
        --rmt_checkpoint /home/jovyan/dnalm/runs/annotation/bert_base_512_lastln_t2t_1000G_bs256_lr_1e-04_linear_fp16/model_2000000/rmt_seglen_512_len42000_maxnsegm_10000_msz_5_bptt-1_lr5e-05_AdamW_cosine_wd1e-04_p10_bs64_it50000/run_1/model_best/pytorch_model.bin \
